...
const ProductDetail = ({ route }) => {
    ...
    const onAddtoCart = async () => {
        const cartDetails = {
            ...
            owner_id: product_detail?.userId,
            quantity: quantity != 1 ? quantity : 1,
            image: product_detail?.productImage ? `https://appsdemo.pro/Texas_Server/${product_detail?.productImage[0]}` : Images.dummy,
        }
            ...
            <ScrollView style={{ flexGrow: 1 }}>
                <View style={styles.swipeWrapper}>
                    {product_detail?.productImage ?
                        ...
                        :
                        <Image source={Images.dummy} style={styles.imageStyle} resizeMethod='cover' />
                    }
                </View>
                <View style={styles.subContainer}>
                    ...
                    <View style={styles.reviewGroup}>
                        <SVGIcon
                            image={icons.star}
                        />
                        <Text style={styles.ratingText}>{product_detail?.AvaRating.toFixed(1)}<Text style={[styles.ratingText, { fontWeight: '100' }]}>  (1120 views)</Text></Text>
                    </View>
