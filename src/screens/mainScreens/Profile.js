...
import { profileOptions, responsiveFontSize, responsiveHeight } from '../../utils'
      ...
      <View style={styles.subContainer}>
        <View style={styles.profileContainer}>
          ...
          <View style={styles.nameContainer}>
            <Text style={styles.nameStyle}>Awolalu Andrew</Text>
            <Text style={[styles.nameStyle, { fontWeight: 'light', fontSize: responsiveFontSize(1.8) }]}>awolaluandrew@gmail.com</Text>
