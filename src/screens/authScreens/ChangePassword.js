...
import { useChangePasswordMutation, useResetPasswordMutation } from '../../redux/Services'
...
const ChangePassword = ({ route }) => {
    ...
    const [changePassword, { isLoading: isChangeLoader }] = useChangePasswordMutation()
            ...
            <ImageBackground style={{ flex: 1 }} source={Images.layer}>
                ...
                <ScrollView contentContainerStyle={styles.background}>
                    ...
                    <Button
                        ...
                        loading={screenType === 'reset' ? isLoading : isChangeLoader}
                        onPress={() => onResetPassword()}
                        title={screenType === 'reset' ? 'Reset Password' : 'Change Password'}
                    />
                </ScrollView>
            </ImageBackground>
        </ImageBackground>
