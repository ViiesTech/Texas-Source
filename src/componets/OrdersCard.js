...
const OrdersCard = props => {
  ...
  return (
    <TouchableOpacity
      ...
      style={[styles.orderView, props?.style]}>
      ...
      <View>
        ...
        <View
          style={{alignItems: 'flex-end', marginRight: responsiveHeight(1)}}>
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
            <Text
              style={{color: Colors.black, fontSize: responsiveFontSize(1.6)}}>
